                    ...
                    <div class="card">
                                    ...
                                    @foreach($comments as $comment)
                                        ...
                                        <li class="chat-item {{($comment->from_id == Auth::id()) ? 'odd' : '' }}">
                                            <div class="chat-content">
                                                ...
                                                @else
                                                    <h6 class="font-medium">{{(isset($comment->client->name))?$comment->client->name:''}}</h6>
                                                @endif
                        ...
                        <div class="card-footer chat-footer">
                            <form action="{{route('customer-support.store')}}" method="post">
                                ...
                                <button type="submit" class="btn btn-icon btn-theme"><i
    ...
    <script>
        function Cancel(id) {
            Swal.mixin({
                ...
                if (result.value) {
                    var url = "{{route('customer-support.update',['id'=>''])}}/" + id;
                    $.ajax({
                        url: url,
                        type: 'PATCH',
